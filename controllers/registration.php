...
if ($_POST) {
	...
	if(count($errors) == 0){
		...
		if ($connection){
			...
			$query = "INSERT INTO `user_info` (`first_name`, `surname`, `email`, `password`, `contact_no`, `city`, `area`, `gender`) VALUES ( '$first_name', '$surname', '$email', '$password', '$contact_no', '$city', '$area', '$gender')";
